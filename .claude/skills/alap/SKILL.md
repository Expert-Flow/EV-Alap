# /alap — Márka-feltárás varázsló (EV-Alap belépési skill)
...
10 kérdés, 4 rész, 60-90 perc. Az első kérdés a legnehezebb. Ott akár 10 percig is gondolkodhatsz — ez normális. A többi gyorsabban megy. Szétoszthatod 2-3 napra. A válaszaid automatikusan mentődnek a fájlba.

A végén egy átemelhető fájl-csomagot kapsz, amit egy az egyben beolvasol az EV-AIOS repo-ba és onnan tudja kit, mit, kinek, hogyan szolgálsz.
...
- A teljes intake-ből legenerálja a következő fájlokat:
  ...
  - `references/voice.md` (Q7+Q8 alapján — szó szerinti hangminta + megfigyelt jellemzők)
  - `kimenet/ev-aios-atadas.md` (átadás-dokumentum az EV-AIOS Q1-be való átemeléshez)
...
- **Nem ad audit-pontszámot.** Tisztán márka-feltárás setup.
- **Nem ír felül kézzel szerkesztett fájlokat figyelmeztetés nélkül.**
- **Nem generál címkéket vagy slogan-t.** A márka-feltárás az *anyagok* feltárása, nem a marketing-csomagolás. Az utóbbi az EV-AIOS feladata.

## Részek

### 1. rész — Intake ellenőrzés

Olvasd be az `alap-intake.md`-t. Ellenőrizd, melyik Q1-Q10 kérdés van kitöltve és melyik nem (a `[A te válaszod]` vagy `[Minta 1 — szó szerint, nyersen]` helyettesítő szöveg = nincs kitöltve).

Ha minden ki van töltve, ugorj a 3. részre.

### 2. rész — Hiányzó kérdések interjúja (4 részes struktúra)

Egyenként kérdezd végig a hiányzó kérdéseket, **a rész-sorrendet betartva**:
...
**Egyszerre EGY kérdés.** Várj válaszra. A választ mentsd vissza az `alap-intake.md`-be (str_replace-szel a helyettesítő szöveg helyére).
...
> "Írd azt hogy 'még nincs, de ezt fogom csinálni' — és írd le az előzetes gondolatodat. A kezdő hangja igazibb mint a kitalált történet."

#### Q7 — Kevert hang figyelmeztetés (kötelező szigorú)
HA a felhasználó NEM illeszt be szó szerinti szöveget, hanem leírja "mit szokott írni", JELEZD:
...
>
> "Ha most ülsz a Claude-dal és tőle kérdezed, az NEM hangminta — az kevert hang lesz (ha a Claude-dal beszélgetve gépelsz, az a hang már nem teljesen a tied — keveredik az AI fordulataival). Másold be egy Messengerből, Gmailből, LinkedIn drafból. Szó szerint."

A hangminta igazi KELL legyen, különben a `references/voice.md` használhatatlan lesz az EV-AIOS-ban.

#### Q10 — Konkrét pillanat-keresés
Ha a válasz általános ("amikor segítségre van szüksége"), kérdezz vissza:
> "Konkrét élethelyzetet keresünk. Mi történik aznap reggel az életében, hogy lecsapja a kávét és azt mondja 'na most kell valaki, aki ebben segít'? 1-3 ilyen pillanatot sorolj fel."

### 3. rész — Fájlgenerálás
...
[Q2-ből: mit kap az ügyfél. Pontosan mit kap fizetés után.]

## Mitől vagyok más
[Q3-ból: miért engem. Ha „még nincs", írd be az előzetes gondolatot explicit jelzéssel: „Még nem teszteltem ügyfeleken — ez egyelőre feltevés."]
...
## Döntési pillanatok
[Q10 válaszai. 1-3 konkrét pillanat, ami után az ICP keresni kezd.]

## Felmerülő nyitott kérdések
[Amik a Q9-Q10 alapján nyitottak maradtak — pl. "Kapacitás nincs definiálva", "Ár nincs piacon tesztelve" — Claude ide jegyzi fel hogy később az EV-AIOS `/fejlesztes` skill ezt felvegye.]
```

#### `references/voice.md` — Hangminta

Q7 szó szerinti mintái + Q8 helyzeti kontextus. Struktúra:
...
### Minta 1
[Q7 első mintája — VÁLTOZTATÁS NÉLKÜL másold be. Ha helyesírási hiba van benne, az is maradjon. Az igaziság fontosabb mint a tisztaság.]

### Minta 2
[Q7 második mintája — ugyanúgy szó szerint.]
...
- Ne használj LinkedIn-szóhasználatot („leverage", „synergy") — üres divatszavakat.
- Ne adj „motivációs" sortöréseket („Egyszerű.\nVilágos.\nKész.") ha a mintákban nincs ilyen.]
```

#### `kimenet/ev-aios-atadas.md` — Átadás az EV-AIOS-hoz
...
Ez a fájl annak a hídja, amit az EV-Alap márka-feltárás-ben tisztáztál, és amit az EV-AIOS `ev-intake.md` várja.
...
Ezt másold be az EV-AIOS `ev-intake.md` Q1 helyettesítő szöveg helyére:

(itt egy 3-bekezdéses szöveg jön)

---

## 2. EV-AIOS `ev-intake.md` Q2 — hangminták

Az EV-AIOS Q2 szó szerinti szövegmintákat kér. Másold be a Q7 mintáit ide.
...
4. `references/voice.md` (ha az EV-AIOS-ban még üres template, írd felül)
...
**Konfliktuskezelés**: Ha valamelyik fájl már létezik az EV-Alap-ban és tartalmaz tartalmat (nem a default helyettesítő szöveg), KÉRDEZZ a felhasználótól:

> "A `[fájlnév]` már tartalmaz adatot. Felülírjam, egybeolvasszam (a régit megtartva, az újat hozzáadva), vagy hagyjam érintetlenül?"

### 4. rész — Záró összefoglaló
...
3. Egy explicit checklist a felhasználónak:
   ...
   - [ ] Töltsd le a saját gépedre (klónozd) az EV-AIOS repo-t (ha még nincs meg)
...
Egy kitöltött EV-Alap, készen az EV-AIOS-ba való átemelésre. A felhasználó már **nem fog homályosan elindulni** — az AIOS-a egy konkrét identitásra, konkrét ICP-re, konkrét ajánlatra és igazi hangra fog épülni.
